...
depends=('xz' 'fuse' 'libxml2' 'icu' 'openssl' 'bzip2' 'zlib' 'libsystemd'
    'wget' 'curl' 'sqlite' 'ruby' 'sed' 'libarchive' 'file' 'python' 'gawk' 'libunwind' 'ffmpeg' 'libcap')
_depends_x86_64=('lib32-clang' 'lib32-bzip2' 'lib32-systemd' 'lib32-libxslt' 'libpng' 'cairo' 'libtiff' 'glu' 'libbsd' 'python2')
makedepends=('git' 'cmake' 'clang' 'dkms' 'bison' 'flex' 'binutils>=2.28' 'libpng' 'cairo' 'libtiff' 'glu' 'libbsd' 'python2' 'linux-headers' 'ffmpeg' 'libcap' 'git-lfs')
...
source=('darling-libressl-2.2.9'::'git+https://github.com/darlinghq/darling-libressl.git#branch=v2.2.9'
        ...
        'git+https://github.com/darlinghq/darling-cocotron.git#branch=darlingserver'
        ...
        'git+https://github.com/darlinghq/darling-dmg.git#branch=darlingserver'
        ...
        'git+https://github.com/darlinghq/darling.git#branch=darlingserver'
        ...
        'git+https://github.com/darlinghq/darling-libkqueue.git#branch=darlingserver'
        ...
        'git+https://github.com/darlinghq/darling-libpthread.git#branch=darlingserver'
        ...
        'git+https://github.com/darlinghq/darling-syslog.git#branch=darlingserver'
